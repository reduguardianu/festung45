...
public class BitmapLoader {
    public static BufferedImage loadBitmap(String file) throws IOException {
        ...
        try {
            ...
            if (nBitCount == 32)
            {
            	image = read32BitBitmap(nSizeImage, nHeight, nWidth, input);
            }
            ...
            {
                System.out.println("Not a 32-bit or 24-bit or 8-bit Windows Bitmap, aborting...");
                image = null;
            }
        } finally {
            try {
    ...
    /********************************************************************/
    private static BufferedImage read32BitBitmap(int nSizeImage, int nHeight, int nWidth, InputStream input) throws IOException {
